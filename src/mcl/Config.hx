...
class Config {
	...
	public final features:FeatureFlags = new FeatureFlags();
	...
	public static function create(base:UserConfig):Config {
		...
		if (base.formatVersion != null)
			...
			final content = File.getContent(Path.join([Sys.getCwd(), 'pack.mcmeta']));
	...
	static function mergeFeatureFlagsToConfig(c:Config) {}
}
...
interface UserConfig {
	 ...
	 */
	public var formatVersion:Null<Int>;
}
